...
gdal.DEMProcessing(slope_path, reproj_dem, "slope", format="GTiff", computeEdges=True)
gdal.DEMProcessing(aspect_path, reproj_dem, "aspect", format="GTiff", computeEdges=True)
gdal.DEMProcessing(hillshade_path, reproj_dem, "hillshade", format="GTiff", computeEdges=True)
...
plt.title("Slope Map - Donimalai (cleaned)")
plt.show()

with rasterio.open(reproj_dem) as src:
    print(src.meta)
    print(src.descriptions)
    print(src.tags())
    print(src.scales, src.offsets)
