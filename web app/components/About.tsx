  ...
  return (
    <div className="bg-[#f9f5f0] text-gray-900 py-24">
      ...
      >
        ...
        {/* Right Side: AI-Powered Protection */}
        <div className="bg-[#f3e8d0]/90 rounded-xl h-[500px] flex items-center justify-center relative overflow-hidden shadow-lg border border-[#e6d3a3]">
          {/* Subtle grid overlay */}
